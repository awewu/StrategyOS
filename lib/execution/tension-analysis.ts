...
export const TENSION_META: Record<TensionType, {
  ...
  direction: {
    ...
    bgColor: "bg-[color-mix(in_srgb,var(--color-accent)_10%,white)]",
    borderColor: "border-[color-mix(in_srgb,var(--color-accent)_35%,transparent)]",
  ...
  resource: {
    ...
    bgColor: "bg-[var(--accent-sim-dim)]",
    borderColor: "border-[color-mix(in_srgb,var(--accent-sim)_35%,transparent)]",
  ...
  capability: {
    ...
    bgColor: "bg-[color-mix(in_srgb,var(--signal-red)_10%,white)]",
    borderColor: "border-[color-mix(in_srgb,var(--signal-red)_35%,transparent)]",
  ...
  adaptation: {
    ...
    bgColor: "bg-[color-mix(in_srgb,var(--signal-yellow)_10%,white)]",
    borderColor: "border-[color-mix(in_srgb,var(--signal-yellow)_35%,transparent)]",

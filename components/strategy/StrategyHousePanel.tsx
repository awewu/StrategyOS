    ...
    <section className="w-full overflow-x-auto">
      <div className="grid" style={{ gridTemplateColumns: "1fr 1fr" }}>
        <div className="rounded-tl-lg bg-[var(--house-mission)] p-4 text-white">
          <div className="mb-1 text-[11px] font-semibold uppercase tracking-widest opacity-80">使 命</div>
          <p className="text-sm leading-snug font-medium">{mission}</p>
        </div>
        <div className="rounded-tr-lg bg-[var(--house-vision)] p-4 text-white">
          <div className="mb-1 text-[11px] font-semibold uppercase tracking-widest opacity-80">愿 景</div>
      ...
      <div className="grid border-b border-[var(--surface-border)]" style={{ gridTemplateColumns: `repeat(${n},1fr)` }}>
        {COLS.map((k, i) => {
          ...
          return (
            ...
            >
              <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-[var(--house-vision)]">
                {COL_LABEL[k]}
              </div>
      ...
      <div className="grid border-b border-[var(--surface-border)]" style={{ gridTemplateColumns: `repeat(${n},1fr)` }}>
        {COLS.map((k, i) => {
          ...
          return (
            ...
            >
              <div className="mb-2 text-[11px] font-semibold uppercase tracking-wider text-[var(--house-annual)]">
                {COL_LABEL[k]}
              </div>

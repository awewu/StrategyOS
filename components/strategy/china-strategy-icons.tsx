 ...
 * Colors: lib/brand/ppt-palette.ts (zero inline brand hex)
 */

import type { ReactNode } from "react";
import { PPT } from "@/lib/brand/ppt-palette";
...
export function IconCart() {
  return (
    <svg viewBox="0 0 64 64" className="ppt-ico ppt-ico--md" aria-hidden>
      <g fill="none" stroke={PPT.iconStroke} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 18h34l-4 22H18L12 18z" fill={PPT.iconFillMuted} stroke={PPT.iconStroke} />
        <circle cx="22" cy="48" r="3" fill={PPT.iconStroke} stroke="none" />
        <circle cx="40" cy="48" r="3" fill={PPT.iconStroke} stroke="none" />
        <path d="M8 14h8l3 8" />
      </g>
    </svg>
  );
...
export function IconPlus() {
  return (
    <svg viewBox="0 0 20 20" className="ppt-ico-plus" aria-hidden>
      <path fill={PPT.iconFillMuted} d="M9 2h2v16H9zM2 9h16v2H2z" />
    </svg>
  );
}
    ...
    <svg viewBox="0 0 64 64" className="ppt-ico ppt-ico--md" aria-hidden>
      <defs>
        <radialGradient id="coinG" cx="40%" cy="35%" r="65%">
          <stop offset="0%" stopColor={PPT.coinHighlight} />
          <stop offset="100%" stopColor={PPT.coin} />
        </radialGradient>
      </defs>
      <circle cx="32" cy="32" r="26" fill="url(#coinG)" stroke={PPT.coinStroke} strokeWidth="1" />
      <text x="32" y="40" textAnchor="middle" fill={PPT.white} fontSize="26" fontWeight="700" fontFamily="Arial">
        $
      </text>
    </svg>
  );
...
export function IconLeaf() {
  return (
    <svg viewBox="0 0 64 64" className="ppt-ico ppt-ico--md" aria-hidden>
      <circle cx="32" cy="32" r="28" fill={PPT.white} stroke={PPT.leaf} strokeWidth="2.5" />
      <path
        fill={PPT.leaf}
...
export function IconExpertise() {
  return (
    <svg viewBox="0 0 72 72" className="ppt-ico ppt-ico--lg" aria-hidden>
      <ellipse cx="36" cy="48" rx="18" ry="20" fill={PPT.iconFillDark} />
      <circle cx="36" cy="30" r="17" fill={PPT.iconFillMid} />
      <path fill={PPT.starGold} d="M36 10l3 10h10.5l-8.5 6.5 3.5 10.5-9-6.5-9 6.5 3.5-10.5-8.5-6.5H33z" />
    </svg>
  );
}
...
export function IconGlobe() {
  return (
    <svg viewBox="0 0 72 72" className="ppt-ico ppt-ico--lg" aria-hidden>
      ...
      <ellipse cx="36" cy="36" rx="28" ry="11" fill="none" stroke={PPT.white} strokeWidth="1.5" opacity="0.8" />
      <ellipse cx="36" cy="36" rx="11" ry="28" fill="none" stroke={PPT.white} strokeWidth="1.5" opacity="0.8" />
      <path d="M8 36h56M36 8v56" stroke={PPT.white} strokeWidth="1" opacity="0.5" />
    </svg>
  );
}
...
export function IconProductTech() {
  return (
    <svg viewBox="0 0 68 68" className="ppt-ico ppt-ico--badge" aria-hidden>
      <circle cx="34" cy="34" r="32" fill={PPT.iconBadgeBg} stroke={PPT.iconBadgeStroke} strokeWidth="1" />
      <rect x="16" y="24" width="12" height="22" rx="1" fill={PPT.iconFillMuted} />
      <rect x="30" y="18" width="14" height="28" rx="1" fill={PPT.iconStroke} />
      <rect x="33" y="22" width="8" height="6" rx="1" fill={PPT.iconFillMuted} />
    </svg>
  );
}
...
export function IconChannels() {
  return (
    <svg viewBox="0 0 68 68" className="ppt-ico ppt-ico--badge" aria-hidden>
      <circle cx="34" cy="34" r="32" fill={PPT.channels} stroke={PPT.channelsStroke} strokeWidth="1" />
      <circle cx="26" cy="28" r="6" fill={PPT.white} />
      <circle cx="42" cy="28" r="6" fill={PPT.white} />
      <path fill={PPT.white} d="M18 46c0-6 6-10 16-10s16 4 16 10v4H18v-4z" />
    </svg>
  );
}
...
export function IconTalent() {
  return (
    <svg viewBox="0 0 68 68" className="ppt-ico ppt-ico--badge" aria-hidden>
      <circle cx="34" cy="34" r="32" fill={PPT.talent} stroke={PPT.talentStroke} strokeWidth="1" />
      <circle cx="34" cy="26" r="6" fill={PPT.white} />
      <path fill={PPT.white} d="M20 52c0-8 6-14 14-14s14 6 14 14" />
      <circle cx="18" cy="30" r="4.5" fill={PPT.white} opacity="0.9" />
      <circle cx="50" cy="30" r="4.5" fill={PPT.white} opacity="0.9" />
    </svg>
  );
}
...
export function DoctrineRing({ active }: RingProps) {
  ...
  return (
    <svg viewBox="0 0 64 64" className="ppt-ring" aria-hidden>
      <circle cx="32" cy="32" r="30" fill={PPT.white} stroke={PPT.borderLight} strokeWidth="0.75" />
      {keys.map((k) => (
        <path
          key={k}
      ...
      <circle cx="32" cy="32" r="11" fill={PPT.white} />
      {keys.map((k) => {
        ...
        return (
          <text
            ...
            fill={k === active ? PPT.white : PPT.ringLabelInactive}
...
export function IconChart() {
  return (
    <svg viewBox="0 0 64 64" className="ppt-ico ppt-ico--md" aria-hidden>
      ...
      <path d="M8 54h48" stroke={PPT.axisLine} strokeWidth="1.5" />
    </svg>
  );
}
...
export function IconFinance() {
  return (
    <svg viewBox="0 0 64 64" className="ppt-ico ppt-ico--md" aria-hidden>
      <circle cx="32" cy="32" r="26" fill={PPT.financeBg} stroke={PPT.financeStroke} strokeWidth="1.5" />
      <text x="32" y="40" textAnchor="middle" fill={PPT.financeText} fontSize="28" fontWeight="700" fontFamily="Arial">
        ¥
      </text>
    </svg>
  );

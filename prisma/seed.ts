...
async function main() {
  ...
  await prisma.capStackPeriod.upsert({
    ...
    create: {
      ...
      byBrandJson: { RUUD: 35, EVERHOT: 30, RHEEM: 25, AUQAHART: 10 },
      ...
      data: [
        {
          ...
          whereToPlayJson: { summary: "酒店·别墅大宅·工程配套" },
          howToWin: "工程系统方案 + 项目配套交付",
          mustHaveCapabilities: ["工程交付", "项目配套"],
        ...
        },
        {
          ...
          whereToPlayJson: { summary: "暖通经销批发渠道" },
          howToWin: "经销网络深度 + 批发走量",
          mustHaveCapabilities: ["渠道数字化", "批发网络"],
          linkedBscDimensionIds: [],
          linkedObjectiveIds: [],
        },
        {
          ...
          whereToPlayJson: { summary: "高端热泵·零售门店" },
          howToWin: "高端热泵产品 + 门店体验",
          mustHaveCapabilities: ["热泵平台", "零售门店运营"],
          linkedBscDimensionIds: [],
          linkedObjectiveIds: [],
        },
        {
          ...
          whereToPlayJson: { summary: "水箱·水力中心·混水泵站" },
          howToWin: "系统部件产品线 + 暖通渠道预留",
          mustHaveCapabilities: ["水力系统研发"],
          linkedBscDimensionIds: [],
          linkedObjectiveIds: [],
        },
      ],
